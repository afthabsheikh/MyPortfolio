...
export default function About(props) {
    ...
    <>
        ...
        <div className="about-section">
            ...
            <p className="about-intro">Hello! I am <span style={{color:'orange'}}>Afthab Sheikh</span> a passionate and driven BCA graduate with a strong foundation<br/> in web development, python development and a keen interest in technology. Throughout my journey, I have honed my skills in Python, Django, React, and other modern web technologies, striving to build efficient and user-friendly applications. With hands-on experience in frontend and backend development, I've developed projects like a classroom app and an attendance system, showcasing my ability to solve problems and deliver impactful solutions.</p>
